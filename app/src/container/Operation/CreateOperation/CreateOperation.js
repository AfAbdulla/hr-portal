...
function CreateOperation() {
   ...
   /*         "achievementAmount": 0,
            ...
            "evenFromBusinessTripDate": businessTripStart !== null ? moment(businessTripStart).format("MM-DD-YYYY") : null,
            "evenToBusinessTripDate": businessTripEnd !== null ? moment(businessTripEnd).format("MM-DD-YYYY") : null,
                                ...
                                <Tabs activeKey={tab}>
                                        ...
                                        <Row>
                                            ...
                                            <Col xs={6}>
                                                <Form.Group>
                                                    ...
                                                    <Form.Label>
                                                        <Form.Control placeholder="Həvalə olunan vəzifənin aid olduğu struktur bölmə"
                                                                      value={positionDepartment || ''}
                                                                      disabled={true}/>
                                                    </Form.Label>
                                                </Form.Group>
                                            ...
                                            <Col xs={6}>
                                                <Form.Group>
                                                    ...
                                                    <Form.Label>
                                                        <Form.Control placeholder="Həvalə olunan vəzifənin aid olduğu alt struktur bölmə"
                                                                      value={positionSubDepartment || ''}
                                                                      disabled={true}/>
                                                    </Form.Label>
                                                </Form.Group>
                                    ...
                                    <Tab eventKey="17" title="" disabled={tab !== "17"}>
                                        <Row>
                                            ...
                                            <Col xs={12}>
                                                <Form.Group>
                                                    <span className="input-title">Məzuniyyətin iş ili dövrü (dövrləri):  </span>
                                                    <div className="flex">
                                                        <Form.Label className="relative m-0">
                                                            <DatePicker selected={startDate}
                                                                        dateFormat="dd-MM-yyyy"
                                            ...
                                            <Col xs={6}>
                                                <Form.Group>
                                                    ...
                                                    <Form.Label>
                                                        <Form.Control placeholder="Təhsil (yaradıcılıq) məzuniyyətinin müddəti "
                                                                      value={dayInEvent}
                                                                      type="number"
                                    ...
                                    <Tab eventKey="30" title="" disabled={tab !== "30"}>
                                        <Row>
                                            ...
                                            <Col xs={6}>
                                                <Form.Group>
                                                    <span
                                                        className="input-title">İşçi (lər)nin soyadı, adı, atasının adı </span>
                                                    <Select
                                                        placeholder="İşçinin adı, soyadı, atasının adı"
